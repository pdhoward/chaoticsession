      ...
      return (
        ...
        <div className={classNames(style.chat)}>
				<div className={classNames(style.chattitle)}>
						<h1>{currentUser}</h1>
			    	<figure className={classNames(style.avatar)}>
			      	<img src={getGravatar(currentUser)} />
						</figure>
			  </div>
...
class Messages extends React.Component {
	...
	render() {
		...
		return (
			<div className={classNames(style.messagecontent)}>
				{messages}
			</div>
		);
	}
...
class Message extends React.Component {
	...
	render() {
			return (
				<div className={classNames(style.messagecontent)} ref={node => this.textmessage = node}>
